...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x1b,0x48); //48
	...
	write_cmos_sensor(0x1f,0xc9); //c8//rsgl_s_mode/vpix_s_mode ƹܺ
	write_cmos_sensor(0x20,0x71);
	write_cmos_sensor(0x21,0x20); //rsg ƹܺ   //////40
	write_cmos_sensor(0x22,0x80); //a0   //80  //f0
	...
	write_cmos_sensor(0x2b,0x80); //00 sf_s_mode FPN
	...
	//////////////////////	 gain   /////////////////////
	/////////////////////////////////////////////////////
	write_cmos_sensor(0xb0,0x68);//50
	write_cmos_sensor(0xb1,0x01);
	write_cmos_sensor(0xb2,0x00);
	...
	printk("yinyapeng add gc2355 init\n");
}    /*    sensor_init  */
...
UINT32 GC2355_MIPI_RAW_SensorInit(struct PSENSOR_FUNCTION_STRUCT *pfFunc)
{
