...
//extern UsedMainCameraType g_CurrUsedMainCameraName;
//<==end
...
{
	printk("yinyapeng add s5k5e2 return id\n");
...
static void sensor_init(void)
{
   ...
   // +++++++++++++++++++++++++++//                                                               
	...
	printk("yinyapeng add s5k5e2 sensor init\n");
}	/*	sensor_init  */
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {		
				//printk("yinyapeng add get_s5k5e2_id\n");
				//g_CurrUsedMainCameraName = MAIN_S5K5E2;
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	set_mirror_flip(imgsensor.mirror);//by likai add
	return ERROR_NONE;
}	/* capture() */
